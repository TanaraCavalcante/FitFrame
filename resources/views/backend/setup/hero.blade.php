...
@section('content')
    <div class="card border-0 mb-3 py-3">
        <div class="card-body">
            ...
            @if ($gyms->isNotEmpty())
                <hr>
                <form method="GET" action="{{ route('backend.setup.hero') }}"
        ...
        <div class="card border-0">
            <div class="card-body">
                <ul class="nav nav-underline mb-4">
                    <li class="nav-item">
                        <button type="button" class="nav-link active tab-toggle-btn hover-accent" data-tab-group="hero" data-tab-target="hero-testo"><i class="fa-solid fa-align-left me-1"></i>Testo</button>
                    </li>
                    <li class="nav-item">
                        <button type="button" class="nav-link tab-toggle-btn hover-accent" data-tab-group="hero" data-tab-target="hero-visual"><i class="fa-solid fa-photo-film me-1"></i>Visual</button>
                    </li>
                </ul>

                <div data-tab-group="hero" data-tab-panel="hero-testo">
                    <div class="row">
                ...
                <div data-tab-group="hero" data-tab-panel="hero-visual" class="d-none">
