...
@section('breadcrumb')
        ...
        <li class="breadcrumb-item"><span class="fs-7">Nuovo Corso</span></li>
@endsection
...
@section('content')
    <div class="card border-0 mb-3 py-3">
        <div class="card-body">
            <div class="d-flex justify-content-between align-items-center">
                <h1 class="h3 mb-0">Nuovo Corso</h1>
    ...
    <div class="card border-0">
        <div class="card-body">
            <form id="corso-form" method="POST" action="{{ route('backend.setup.corsi.store') }}">
                @csrf
