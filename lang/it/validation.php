...
return [
    ...
    'attributes' => [
        ...
        'image_5' => 'immagine 5',
        'video' => 'video',
        'visual_mode' => 'modalità visual',
        'hero_kicker' => 'kicker',
        'hero_title' => 'titolo',
        'hero_subtitle' => 'sottotitolo',
        'hero_cta_primary' => 'CTA primario',
        'hero_cta_secondary' => 'CTA secondario',
        'hero_stat_number' => 'numero statistica',
        'hero_stat_label' => 'etichetta statistica',
        'email' => 'email',
        'password' => 'password',
    ],
